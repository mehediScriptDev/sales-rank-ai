...
const Footer = () => {
  return (
    <section className="bg-anotherbg pt-20">
        <div className="bg-toBg w-10/12 mx-auto rounded-md py-10 md:py-20">
            <div>
                <h1 className="text-2xl md:text-3xl text-white font-bold py-2 text-center">Ready to Hire Smarter?</h1>
                <p className="text-sm text-slate-300 text-center py-1">Unlock Exclusive Insights Subscribe to Our Newsletter</p>
                <div className="flex justify-center items-center pt-3">
                    <button className="btn bg-yellow-500 border-transparent rounded-full">Join now</button>
                </div>
            </div>
        </div>
